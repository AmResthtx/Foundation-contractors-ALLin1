...
| `statewide-monitoring` | daily | Same engine, Texas-wide feeds (`STATEWIDE_FEEDS`, default Texas Tribune environment topic + Texas Water Newsroom/TWDB); narrower alert keywords to keep high-volume feeds quiet. See `hermes/research/statewide-monitoring.md`. |
